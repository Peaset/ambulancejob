...
AddEventHandler('esx_ambulancejob:useItem', function(itemName)
	...
	if itemName == 'medikit' then
		...
		ESX.Streaming.RequestAnimDict(lib, function()
			...
			exports['mythic_notify']:SendAlert('success', 'Medkit Kullanıldı.',2500) 
		end)
	...
	elseif itemName == 'bandage' then
		...
		ESX.Streaming.RequestAnimDict(lib, function()
			...
			exports['mythic_notify']:SendAlert('success', 'Bandaj Kuıllanıldı.',2500) 
		end)

	elseif itemName == 'merhem' then
		local lib, anim = 'anim@heists@narcotics@funding@gang_idle', 'gang_chatting_idle01' -- TODO better animations
		local playerPed = PlayerPedId()
		...
		ESX.Streaming.RequestAnimDict(lib, function()
			...
			TriggerEvent('esx_ambulancejob:heal', 'small', true)
			exports['mythic_notify']:SendAlert('success', 'Merhem Kullanıldı',2500) 
		end)
		
	elseif itemName == 'ilac' then
		local lib, anim = 'anim@heists@narcotics@funding@gang_idle', 'gang_chatting_idle01' -- TODO better animations
		local playerPed = PlayerPedId()
		...
		ESX.Streaming.RequestAnimDict(lib, function()
			...
			TriggerEvent('esx_ambulancejob:heal', 'small', true)
			exports['mythic_notify']:SendAlert('success', 'Ilaç Ictiniz.',2500) 
		end)
	end
end)
