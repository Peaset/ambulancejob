	...
	while true do
		...
		for hospitalNum,hospital in pairs(Config.Hospitals) do
			...
			for k,v in ipairs(hospital.AmbulanceActions) do
				...
				if distance < Config.Marker.x and ESX.PlayerData.job.name == 'ambulance' then
			...
			for k,v in ipairs(hospital.Vehicles) do
				...
				if distance < v.Marker.x and ESX.PlayerData.job.name == 'ambulance' then
...
function OpenPharmacyMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'pharmacy', {
		...
		align    = 'top-left',
		elements = {
			{label = _U('pharmacy_take', 'Merhem'), item = 'merhem', type = 'slider', value = 1, min = 1, max = 100},
			{label = _U('pharmacy_take', 'İlac'), item = 'ilac', type = 'slider', value = 1, min = 1, max = 100},
